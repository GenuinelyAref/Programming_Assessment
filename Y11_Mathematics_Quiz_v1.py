...
# Define all functions used (and order them into their related sections)
# Add introduction + link it with text enhancer
# Add decimal rounding questions
# Add quadratic equation questions
...
def check_roots(quadratic, first_root, second_root):
    ...
    if user_input[0].lower() == "y":
        print("\n{}\n".format(decorate_print("\U0001F642 \U0001F642 Good job! Next question \U0001F642 \U0001F642", "*", 2)))
        round_trials.append(1)
    else:
        print("\n{}\n".format(decorate_print("\U0001F641 \U0001F641 Sorry, you got that wrong >>> next question \U0001F641 \U0001F641", "!", 2)))
        round_trials.append(TRIALS+1)
